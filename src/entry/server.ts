...
const bundleLoader = `<script defer onload="var s=document.createElement('script');s.src=window['.Modern']?'/modern.js':'/legacy.js';s.defer=true;document.body.appendChild(s);" src="${checkCompatibilityName}"></script>`;
